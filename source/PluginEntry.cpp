/**
	...
	`CFFGLPluginInfo` that Fax.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Fax.bundle/Contents/MacOS/Fax | grep fax
*/

extern "C" const char* FaxBuildStamp()
{
	return "fax " FAX_VERSION " built " __DATE__ " " __TIME__;
}
