...
[![Fax — the clip sent as a Group 3 fax over a noisy line, for Resolume](docs/video-thumb.png)](https://www.youtube.com/watch?v=w-YRqZRX3HI)

*[Watch it](https://www.youtube.com/watch?v=w-YRqZRX3HI) — 58 seconds:
the dancers halftoned at the defaults, bit-error streaks on the tank with concealment off and
then Repeat Line, Standard, Fine and Superfine on the astronaut (cropped three times up), Page
mode sending a sphere line by line at 14400 bit/s, A4 Letterbox and plain paper, and the skulls
with the header off and Mix down to the clip. Every frame is the real plugin's output: an FFGL
plugin has no window, so the footage is rendered by this repository's own offline harness
(`fxtest --pipe`, driven by a cue sheet) rather than filmed off a screen, and the clips are
...
**[v0.1.0](https://github.com/stoatworks-labs/fax/releases/tag/v0.1.0)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`fax-0.1.0-macos-universal.dmg`](https://github.com/stoatworks-labs/fax/releases/download/v0.1.0/fax-0.1.0-macos-universal.dmg) | 266 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`fax-macos-universal.zip`](https://github.com/stoatworks-labs/fax/releases/latest/download/fax-macos-universal.zip) | 223 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`fax-0.1.0-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/fax/releases/download/v0.1.0/fax-0.1.0-windows-x86_64-setup.exe) | 232 KB |
| x64 · .zip archive | [`fax-windows-x86_64.zip`](https://github.com/stoatworks-labs/fax/releases/latest/download/fax-windows-x86_64.zip) | 126 KB |

</details>

All builds, checksums and release notes: [github.com/stoatworks-labs/fax/releases](https://github.com/stoatworks-labs/fax/releases).
